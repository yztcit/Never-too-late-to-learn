package com.nttn.coolandroid.learndrawview;
...
import com.nttn.coolandroid.learndrawview.widget.FollowView;
...
public class DrawViewActivity extends BaseHeadActivity implements View.OnClickListener {
    ...
    private void initFollowView(){
        ...
        followView.setBackgroundColor(getResources().getColor(R.color.color_blue));
    }
}
