 ...
 * RecycleView 侧滑
 * 左滑+长按拖拽:
 * 先添加ItemTouchHelper做长按拖拽，
 * 再添加 addOnItemTouchListener(new SwipeItemLayout.OnSwipeItemTouchListener(this))即可
 */
public class SwipeItemLayout extends ViewGroup {
    ...
    private void ensureChildren() {
        ...
        mainItemView.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                SwipeItemLayout.this.performClick();
            }
        });
    }
